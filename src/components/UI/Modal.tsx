...
const style = tw`bg-white fixed rounded-lg overflow-hidden shadow-xl transform flex flex-col transition-all sm:max-w-md sm:w-full shadow-lg z-10`;
...
const Modal: React.FC<Props> = (props) => {
  ...
  return (
    <animated.div style={spring} css={style}>
      <div tw="mt-3 mb-3 pt-5 pb-4 px-6 flex items-center">
